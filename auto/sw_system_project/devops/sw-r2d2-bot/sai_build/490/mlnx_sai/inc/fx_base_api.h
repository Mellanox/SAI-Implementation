...
/* Device level APIs */
/**
* This function sets the log verbosity level of FX BASE MODULE
* Supported devices: Spectrum, Spectrum2.
*
* @param[in] handle            - FX handle
* @param[in] verbosity_level   - FX_BASE module verbosity level
*
* @return SX_STATUS_SUCCESS
*/

sx_status_t fx_log_verbosity_level_set(fx_handle_t , const sx_verbosity_level_t);
 ...
 *
 * @param[in] sx_handle - optional sx api handle to use, allocated externally
 ...
 */
sx_status_t fx_init(fx_handle_t *handle, const sx_api_handle_t *sx_handle);
...
typedef sx_status_t (*fx_init_fn) (fx_handle_t *handle, const sx_api_handle_t *sx_handle);
typedef sx_status_t (*fx_deinit_fn)(fx_handle_t handle);
typedef sx_status_t (*fx_extern_init_fn)(fx_handle_t handle);
typedef sx_status_t (*fx_extern_deinit_fn)(fx_handle_t handle);
...
//typedef enum fx_table_id {
//    FX_TABLE_INVALID_ID = 0,
//    FX_TABLE_MAX_ID = 0xFFFFFFFF
//} fx_table_id_t;
typedef uint32_t fx_table_id_t;
static const fx_table_id_t FX_TABLE_INVALID_ID = 0;
// autogenerated values go in between
static const fx_table_id_t FX_TABLE_MAX_ID = 0x02FFFFFF;

//typedef enum fx_action_id_t {
//    FX_ACTION_INVALID_ID = 0,
//    FX_ACTION_MAX_ID = 0xFFFFFFFF
//} fx_action_id_t;
typedef uint32_t fx_action_id_t;
static const fx_action_id_t FX_ACTION_INVALID_ID = 0;
// autogenerated values go in between
static const  fx_action_id_t FX_ACTION_MAX_ID = 0x01FFFFFF;

typedef uint32_t fx_counter_id_t;
static const fx_counter_id_t FX_COUNTER_INVALID_ID = 0;
// autogenerated values go in between
static const  fx_action_id_t FX_COUNTER_MAX_ID = 0x12FFFFFF;

typedef uint32_t fx_packet_metadata_id_t;
static const fx_packet_metadata_id_t FX_PACKET_METADATA_INVALID_ID = 0;
// autogenerated values go in between
static const  fx_packet_metadata_id_t FX_PACKET_METADATA_MAX_ID = 0x04FFFFFF;

typedef uint32_t fx_action_profile_id_t;
static const fx_action_profile_id_t FX_ACTION_PROFILE_INVALID_ID = 0;
// autogenerated values go in between
static const  fx_action_profile_id_t FX_ACTION_PROFILE_MAX_ID = 0x11FFFFFF;

typedef uint32_t fx_value_set_id_t;
static const fx_value_set_id_t FX_VALUE_SET_INVALID_ID = 0;
// autogenerated values go in between
static const  fx_value_set_id_t FX_VALUE_SET_MAX_ID = 0x03FFFFFF;
...
typedef sx_status_t (*fx_pipe_create_fn) (fx_handle_t handle,
        fx_pipe_type_t pipe_type,
        void *if_list,
        uint32_t if_list_cnt);

typedef sx_status_t (*fx_pipe_destroy_fn) (fx_handle_t handle,
        fx_pipe_type_t pipe_type,
        void *if_list,
        uint32_t if_list_cnt);

typedef sx_status_t (*fx_pipe_rebind_fn) (fx_handle_t handle,
        fx_pipe_type_t pipe_type,
        void *if_list,
        uint32_t if_list_cnt);
...
typedef sx_status_t (*fx_table_entry_add_fn) (fx_handle_t handle, const fx_table_id_t table_id, const fx_action_id_t action_id, fx_key_list_t keys, fx_param_list_t params, sx_acl_rule_offset_t* offset_ptr);
...
/**
 * @brief Get/free default fx_handle. Pre-initialized, pipes and bindings
 * are done. Used by APIs that might be working together.
 *      Supported devices: Spectrum, Spectrum2.
 *
 * @param[inout] handle - preallocated handle
 * @param[in]    sx_handle - sx api handle
 * @param[in]    do_init - if false, do nothing for uninitialized
 *
 * @return 
 * @return sx_status_t:
 * @return SX_STATUS_SUCCESS - Operation completes successfully
