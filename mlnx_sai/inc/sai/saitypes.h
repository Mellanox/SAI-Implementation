...
typedef struct _sai_aggregated_port_data_t
{
    uint32_t aport;
    uint32_t plane;
    uint32_t num_of_planes;
} sai_aggregated_port_data_t;
...
typedef union _sai_attribute_value_t
{
    ...
    /** @validonly meta->attrvaluetype == SAI_ATTR_VALUE_TYPE_AGGREGATED_PORT_DATA */
    sai_aggregated_port_data_t aport_data;
