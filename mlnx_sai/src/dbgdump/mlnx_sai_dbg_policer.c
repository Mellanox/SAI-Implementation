...
static void SAI_dump_policer_print(_In_ FILE *file, _In_ mlnx_policer_db_entry_t *policers_db)
{
    ...
    dbg_utils_table_columns_t policer_clmns[] = {
        ...
        {"sx policer id acl mirror", 17, PARAM_UINT64_E, &curr_policers_db.sx_policer_id_acl_mirror},
        {"sx policer id span", 17, PARAM_UINT64_E, &curr_policers_db.sx_policer_id_span_session},
