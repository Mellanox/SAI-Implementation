...
static void SAI_dump_port_print(_In_ FILE *file, _In_ mlnx_port_config_t *mlnx_port_config)
{
    ...
    dbg_utils_table_columns_t port_clmns[] = {
        ...
        {"lag ingr acl oid changed",   24, PARAM_UINT8_E,  &curr_mlnx_port_config.issu_lag_attr.lag_ingress_acl_oid_changed},
        {"lag ingr acl oid",           17, PARAM_UINT64_E, &curr_mlnx_port_config.issu_lag_attr.lag_ingress_acl_oid},
        {"lag egr acl oid changed",    23, PARAM_UINT8_E,  &curr_mlnx_port_config.issu_lag_attr.lag_egress_acl_oid_changed},
        ...
        {"lag default vlan pri changed", 29, PARAM_UINT8_E,  &curr_mlnx_port_config.issu_lag_attr.lag_default_vlan_priority_changed},
        {"lag default vlan pri",       21, PARAM_UINT8_E,  &curr_mlnx_port_config.issu_lag_attr.lag_default_vlan_priority},
        {"lag drop untagged changed",  26, PARAM_UINT8_E,  &curr_mlnx_port_config.issu_lag_attr.lag_drop_untagged_changed},
        {"lag drop untagged",          18, PARAM_UINT8_E,  &curr_mlnx_port_config.issu_lag_attr.lag_drop_untagged},
        {"lag drop tagged changed",    24, PARAM_UINT8_E,  &curr_mlnx_port_config.issu_lag_attr.lag_drop_tagged_changed},
