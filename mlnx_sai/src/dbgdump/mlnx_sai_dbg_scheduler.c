...
static void SAI_dump_sched_db_print(_In_ FILE *file, _In_ mlnx_sched_profile_t *sched_db)
{
    ...
    dbg_utils_table_columns_t sched_db_clmns[] = {
        ...
        {"min shaper enable",  14, PARAM_BOOL_E,   &curr_sched_db.ets.min_shaper_enable},
        {"packets mode",       14, PARAM_BOOL_E,   &curr_sched_db.ets.packets_mode},
        {"min shaper rate",    14, PARAM_UINT32_E, &curr_sched_db.ets.min_shaper_rate},
        {"max shaper enable",  14, PARAM_BOOL_E,   &curr_sched_db.ets.max_shaper_enable},
        {"max shaper rate",    14, PARAM_UINT32_E, &curr_sched_db.ets.max_shaper_rate},
        {"dwrr enable",        14, PARAM_BOOL_E,   &curr_sched_db.ets.dwrr_enable},
        {"dwrr",               14, PARAM_BOOL_E,   &curr_sched_db.ets.dwrr},
